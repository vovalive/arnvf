...
VF.counts.all <- read.delim("~/arnvf/VF.counts.all.txt", stringsAsFactors=FALSE)
VF.covered.100pr <- read.delim("~/arnvf/VF.covered.100pr.txt", header=FALSE, stringsAsFactors=FALSE)
VF.genes.desc <- read.delim2("~/arnvf/VF.genes.desc.txt", stringsAsFactors=FALSE)
